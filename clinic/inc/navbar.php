            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        ...
                        <?php if(isset($_SESSION['eslam2'])): ?>
                        <a type="button" class="btn btn-danger navigation--button" href="./logout.php">logout</a>
                        <?php endif; ?>
                        <?php if(!isset($_SESSION['eslam2'])): ?>
                        <a type="button" class="btn btn-outline-light navigation--button" href="./loginform.php">login</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
